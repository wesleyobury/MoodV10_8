...
PREVIEW_FEATURED_WORKOUTS = [
  {
    ...
    "exercises": [
      ...
      },
      {
        ...
        "battlePlan": "Instructions: Low and powerful — drive through the whole foot, chest tall. The walk back to the start is part of your rest.\nPerform 4 rounds:\n• 10 m Push (moderate)\n• 10 m Backward Drag\n• 10 m Lateral Push (sideways)\n• Rest 1 min",
        "duration": "20–22 min",
  ...
  },
  {
    ...
    "exercises": [
      ...
      },
      {
        ...
        "battlePlan": "Instructions: Elbows pinned to your sides — wide grip biases the inner biceps. No swinging.\nBattle Plan — Standard Sets\n• 4×10 Wide-Grip EZ Curl — standard reps\nRest 75s",
        "duration": "14–16 min",
      ...
      },
      {
        ...
        "battlePlan": "Instructions: Keep constant cable tension — never let the stack touch down between reps.\nBattle Plan — Standard Sets\n• 4×10 Incline Cable Curl — standard reps\nRest 75s",
        "duration": "14–16 min",
    ...
    "exercises": [
      {
        ...
        "battlePlan": "Instructions: Ride the pyramid up and back down each round — easy is conversational, hard means you can't talk.\n• 3 rounds:\n• 3 min easy\n• 2 min moderate\n• 1 min hard\n• 2 min moderate\n• 3 min easy",
        "duration": "30 min",
  ...
  },
  {
    ...
    "exercises": [
      ...
      },
      {
        ...
        "battlePlan": "Instructions: Rotate through the full arc — palms face you at the bottom, forward at the top. Smooth, no jerking.\nBattle Plan — Standard Sets\n• 5×10 Arnold Press — standard reps\nRest 75s",
        "duration": "14–16 min",
      ...
      },
      {
        ...
        "battlePlan": "Instructions: Pulses live in the top third — short, controlled, shoulder stays down away from your ear.\nBattle Plan — Pulse Sets\n• 4×15 Cable Lateral Raise — pulse reps (top ⅓)\nRest 75s",
        "duration": "15–17 min",
  ...
  },
  {
    ...
    "exercises": [
      ...
      },
      {
        ...
        "battlePlan": "Instructions: Every rep starts from a clean setup — reset your feet and grip. Power comes from the hips, not the arms.\n4 rounds\n• 4 per side Clean → Jerk\nRest 90s",
        "duration": "10–12 min",
      ...
      },
      {
        ...
        "battlePlan": "Instructions: Step down, never jump down — reset fully so every jump is maximal.\n4 rounds\n• 6–8 Box Jumps\nRest 75s",
        "duration": "10–12 min",
      ...
      },
      {
        ...
        "battlePlan": "Instructions: Slam through the ball, not at it — then pick up fast and flow straight into the next rep.\n4 rounds\n• 8–10 Overhead Slams\n• 8–10 Fast Scoop Resets\nRest 90s",
        "duration": "10–12 min",
    ...
    "exercises": [
      {
        ...
        "battlePlan": "Instructions: Sit back and down — push the floor away through mid-foot and squeeze the glutes to stand.\n4 rounds\n• 8–10 reps\nRest 120s",
        "duration": "14–16 min",
