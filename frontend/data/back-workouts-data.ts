      ...
      beginner: [
        {
          ...
          battlePlan: 'Instructions: Complete ALL reps on one side before switching — no alternating unless written. 3 rounds — all 2 moves in order, then rest 60s.\n3 rounds\n• 10 Single-Arm Dumbbell Row (each side, supported on bench)\nRest 60s after each side\n• 10 Prone Rear Delt Fly (lying face down)\nRest 60s after each set',
          plan: {
            "format": "circuit",
            "blocks": [
              {
            ...
            "blocks": [
              {
                ...
                "movements": [
                  ...
                  {
                    "name": "Incline Prone Y-Raise",
                    "reps": "10"
                  },
                  {
                    "name": "Incline Prone T-Raise",
                    "reps": "10"
                  }
                ],
                "rounds": 3,
            ...
            "blocks": [
              {
                ...
                "movements": [
                  ...
                  {
                    "name": "Incline Prone Reverse Fly",
                    "reps": "10",
    ...
    workouts: {
      beginner: [
        {
          ...
          battlePlan: 'Instructions: 3 rounds — all 2 moves in order, then rest 60–75s.\n3 rounds:\n• 10 Barbell Bent-Over Row\nRest 60–75s after each set\n• 10 Barbell Deadlift\nRest 60–75s after each set',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      intermediate: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: 3 rounds — all 4 moves in order, then rest 90s.\n3 rounds:\n• 8 Bent-Over Row\n• 8 Reverse-Grip Row\n• 8 Barbell Shrugs\n• 8 Deadlift\nRest 90s after finishing the full circuit',
          plan: {
            "format": "circuit",
            "blocks": [
              {
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Cap every set with the finisher: 10s hold — it counts, don\'t skip it. The hold is strict: locked position, squeezing hard, no drifting. 4 sets of 8 — rest 120s between sets, take all of it.\n4 rounds\n• 8 Rows\n• Finish with 10s hold\nRest 120s',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      advanced: [
        {
          ...
          battlePlan: 'Instructions: 4 rounds — all 3 moves in order, then rest 90–120s.\n4 rounds:\n• 8 Barbell Bent-Over Row\nRest 90–120s after each set\n• 8 Barbell Deadlift\nRest 90–120s after each set\n• 8 Barbell Shrug\nRest 90–120s after each set',
          plan: {
            "format": "circuit",
            "blocks": [
              {
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Superset: the paired moves run back-to-back with zero rest — rest only after the pair. 3 rounds — all 3 moves in order, then rest 150s.\n3 rounds\n• 6 Wide-Grip Rows\n• 6 Standard Rows — immediately, no rest\n• 6 Underhand Rows — immediately, no rest\nRest 150s',
          plan: {
            "format": "circuit",
            "blocks": [
              {
    ...
    workouts: {
      beginner: [
        {
          ...
          battlePlan: 'Instructions: Complete ALL reps on one side before switching — no alternating unless written. 3 rounds — all 2 moves in order, then rest 60–75s.\n3 rounds\n• 10 Single-Arm KB Row (each side)\nRest 60–75s after each set\n• 10 KB Deadlift\nRest 60–75s after each set',
          plan: {
            "format": "circuit",
            "blocks": [
              {
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Complete ALL reps on one side before switching — no alternating unless written. 3 rounds — all 3 moves in order, then rest 60–75s.\n3 rounds\n• 10 KB Single-Arm Row (each side)\n• 10 KB Suitcase Deadlift (each side)\n• 10 KB Swing\nRest 60–75s after sequence',
          plan: {
            "format": "circuit",
            "blocks": [
              {
                ...
                "movements": [
                  ...
                  },
                  {
                    ...
                    "reps": "10",
                    "tutorialSlug": "kb_suitcase_deadlift"
                  },
                  {
                    "name": "KB Swing",
                    "reps": "10",
      ...
      intermediate: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Complete ALL reps on one side before switching — no alternating unless written. 3 rounds — all 3 moves in order, then rest 90s.\n3 rounds\n• 8 Renegade Row (each side)\n• 8 Gorilla Row (each side)\n• 8 KB High Pull (each side)\nRest 90s after sequence',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      advanced: [
        {
          ...
          battlePlan: 'Instructions: Complete ALL reps on one side before switching — no alternating unless written. 4 rounds — all 3 moves in order, then rest 90s.\n4 rounds\n• 8 Single-Arm Row (each side)\nRest 90s after set\n• 8 KB Swing\nRest 90s after set\n• 8 KB Deadlift\nRest 90s after set',
          plan: {
            "format": "circuit",
            "blocks": [
              {
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Complete ALL reps on one side before switching — no alternating unless written. 4 rounds — all 3 moves in order, then rest 90–120s.\n4 rounds\n• 8 Renegade Row (alternating sides)\n• 8 KB Snatch (each side)\n• 8 KB Clean and Pull\nRest 90–120s after sequence',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      beginner: [
        {
          ...
          battlePlan: 'Instructions: 3 rounds — all 2 moves in order, then rest 45–60s.\n3 rounds\n• 12 Back Extensions\nRest 45–60s\n• 2 Roman Chair Holds (20s each)\nRest 60s after set',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      intermediate: [
        {
          ...
          battlePlan: 'Instructions: 4 rounds — all 2 moves in order, then rest 75s.\n4 rounds\n• 10 Weighted Back Extensions\nRest 75s after set\n• 10 Roman Chair Hyperextensions\nRest 75s after set',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      advanced: [
        {
          ...
          battlePlan: 'Instructions: 4 rounds — all 3 moves in order, then rest 90s.\n4 rounds\n• 10 Weighted Back Extensions\nRest 90s after set\n• 10 Roman Chair Hyperextensions\nRest 90s after set\n• 10 Roman Chair Twists\nRest 90s after set',
          plan: {
            "format": "circuit",
            "blocks": [
              {
        ...
        },
        {
          ...
          battlePlan: 'Instructions: The hold is strict: locked position, squeezing hard, no drifting. 4 rounds — all 3 moves in order, then rest 90–120s.\n4 rounds\n• 8 Weighted Back Extensions\n• 8 Alternating Supermans\n• 1 Roman Chair Hold (20–30s)\nRest 90–120s after sequence',
          plan: {
            "format": "circuit",
            "blocks": [
              {
    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Superset: the paired moves run back-to-back with zero rest — rest only after the pair. Cap every set with the finisher: 10 Back Squeezes (bodyweight, no load) — it counts, don\'t skip it. 4 rounds — all 2 moves in order, then rest 120s.\n4 rounds\n• 8 Wide Grip Row\n• 8 Underhand Grip Row — immediately, no rest\n• Finish with 10 Back Squeezes (bodyweight, no load)\nRest 120s after full superset',
          plan: {
            "format": "circuit",
            "blocks": [
              {
    ...
    workouts: {
      beginner: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: 3 rounds — all 3 moves in order, then rest 75s.\n3 rounds\n• 10 Barbell Deadlift\n• 10 Barbell Bent-Over Row\n• 10 Barbell Power Shrug\nRest 75s after sequence',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      intermediate: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Every rep at full intent — reset your stance between reps; speed beats load. 3 rounds — all 3 moves in order, then rest 90s.\n3 rounds\n• 8 Barbell Deadlift\n• 8 Barbell High Pull\n• 8 Barbell Clean Pull\nRest 90s after sequence',
          plan: {
            "format": "circuit",
            "blocks": [
              {
    ...
    workouts: {
      ...
      intermediate: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Cap every set with the finisher: 12s hold — it counts, don\'t skip it. The hold is strict: locked position, squeezing hard, no drifting. 4 sets of 8 — rest 120s between sets, take all of it.\n4 rounds\n• 8 Cable Rows\n• Finish with 12s hold\nRest 120s',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Superset: the paired moves run back-to-back with zero rest — rest only after the pair. Cap every set with the finisher: 10 Standing Back Squeezes (bodyweight scapular retractions, no load) — it counts, don\'t skip it. 4 rounds — all 2 moves in order, then rest 120s.\n4 rounds\n• 8 Wide Grip Row (controlled)\n• 8 Underhand Grip Row — immediately, no rest\n• Finish with 10 Standing Back Squeezes (bodyweight scapular retractions, no load)\nRest 120s after full superset',
          plan: {
            "format": "circuit",
            "blocks": [
              {
    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Superset: the paired moves run back-to-back with zero rest — rest only after the pair. Own the lowering — count the seconds down, then move normally on the way up. 4 rounds — all 2 moves in order, then rest 120s.\n4 rounds\n• 8 Wide Grip Pulldown\n• 8 Underhand Pulldown — 3s eccentric each — immediately, no rest\nRest 120s after superset',
          plan: {
            "format": "circuit",
            "blocks": [
              {
    ...
    workouts: {
                ...
                "movements": [
                  {
                    "name": "Assisted Pull-Ups",
                    "reps": "6",
                    "tutorialSlug": "wide_grip_assisted_pull_up"
                  }
                ],
                "rounds": 3,
                "rest": "75s"
      ...
      intermediate: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Cap every set with the finisher: 10s chin-over-bar hold — it counts, don\'t skip it. The hold is strict: locked position, squeezing hard, no drifting. 3 sets of 6 — rest 90s between sets, take all of it.\n3 rounds\n• 6 Pull-Ups\n• Finish with 10s chin-over-bar hold\nRest 90s',
          plan: {
            "format": "circuit",
            "blocks": [
              {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Own the lowering — count the seconds down, then move normally on the way up. 4 rounds — all 2 moves in order, then rest 90–120s.\n4 rounds\n• 6 Chest-to-Bar Pull-Ups\n• 6 Negative Pull-Ups (3–5s lower)\nRest 90–120s after sequence',
          plan: {
            "format": "circuit",
            "blocks": [
              {
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Ladder: work down the rungs — the reps drop as fatigue climbs. Rest only between rungs. Every rep at full intent — reset your stance between reps; speed beats load. Work top to bottom — rest 30–45s between exercises.\nLadder format\n• 8 Pull-Ups\n• 6 Pull-Ups\n• 4 Pull-Ups\n• 2 Pull-Ups\nRest 30–45s between rungs',
          plan: {
            "format": "strength",
            "blocks": [
              {
            ...
            "blocks": [
              {
                ...
                "movements": [
                  {
                    "name": "Assisted Neutral Pull-Ups",
                    "reps": "5",
                    "tutorialSlug": "neutral_grip_assisted_pull_up"
                  }
                ],
    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Superset: the paired moves run back-to-back with zero rest — rest only after the pair. Cap every set with the finisher: 10s Hold at peak contraction — it counts, don\'t skip it. 4 rounds — all 2 moves in order, then rest 120s.\n4 rounds\n• 8 Neutral Grip Row\n• 8 Underhand Grip Row — immediately, no rest\n• Finish with 10s Hold at peak contraction\nRest 120s after full sequence',
          plan: {
            "format": "circuit",
            "blocks": [
              {
