    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Wave scheme 2-2-1: reps per set within each round — rebuild your setup between waves.\n5 rounds\n• Wave 2-2-1 Push Jerks\nRest 120–150s',
          plan: {
            "format": "circuit",
            "blocks": [
              {
                ...
                "movements": [
                  {
                    "name": "Triple Extension Heave",
                    "reps": "4",
                    "tutorialSlug": "landmine_triple_extension_heave"
                  }
                ],
                "rounds": 5,
                "rest": "120s"
    ...
    workouts: {
      ...
      intermediate: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Each round is one wave. Per side scheme 5-4-3: reps per set within each round, each side — rebuild your setup between waves.\n3 rounds\n• Per side 5-4-3 Snatches\nRest 90s between waves',
          plan: {
            "format": "strength",
            "blocks": [
              {
    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Every rep at full intent — reset your stance between reps; speed beats load. 3 sets — rest 150s between sets, take all of it. Each round is one wave.\n3 rounds\n• 5-4-3 Deadlifts (fast concentric)\nRest 150s between waves',
          plan: {
            "format": "strength",
            "blocks": [
              {
            ...
            "blocks": [
              {
                ...
                "movements": [
                  {
                    "name": "10m Trap Bar March"
                  },
                  {
                    "name": "10m Free Sprint"
                  }
                ],
                "rounds": 3,
                "rest": "90s"
