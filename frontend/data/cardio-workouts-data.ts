    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Min hill sprints: 8.0 mph, incline 6%, 1 min walk between. Control the lowering — the tempo is the point.\n• 5 min warm-up (jog)\n• 10 min tempo run (7.0 mph, incline 2%)\n• Min hill sprints — 5 × (1)\n• 5 min cool-down',
          plan: {
            "format": "strength",
            "blocks": [
              {
    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: EMOM — a new interval starts every minute. EMOM: start fresh at the top of every minute, rest whatever time is left.\n• 20 sec sprint\n• 40 sec moderate\n• repeat for 20 min',
          plan: {
            "format": "interval",
            "blocks": [
              {
