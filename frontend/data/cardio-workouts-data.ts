      ...
      beginner: [
        {
          ...
          battlePlan: 'Instructions: Follow the 6 timed segments in order, no skipping.\n• 5 min walk (3.5 mph)\n• 3 min jog (5 mph)\n• 2 min walk (3 mph)\n• 4 min jog (5.2 mph)\n• 3 min walk (3.5 mph)\n• 3 min jog (5 mph)',
          plan: {
            "format": "interval",
            "blocks": [
              {
    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Follow the 5 timed segments in order, no skipping.\n• 5 min easy\n• 10 min moderate\n• 5 min hard\n• 5 min fast\n• 5 min cool-down',
          plan: {
            "format": "interval",
            "blocks": [
              {
    ...
    workouts: {
      ...
      intermediate: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Every rep at full intent — reset your stance between reps; speed beats load. 5 rounds — follow the 3 timed segments in order, no skipping.\nPerform 5 rounds:\n• 10 band squat jumps (band around thighs)\n• band sprints — ~20m, attached to anchor\n• 8 band-assisted push-ups\n• Rest 90 sec\nFinish when all rounds complete',
          plan: {
            "format": "interval",
            "blocks": [
              {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: AMRAP: keep moving through the reps with clean form — rest only when form would break, and log your total. Every rep at full intent — reset your stance between reps; speed beats load. Work top to bottom.\nAMRAP for 20 minutes:\n• 10 jump lunges with band (band around ankles)\n• 20 mountain climbers with band around feet\n• 15 band rows\n• 8 explosive push-ups with band\nScore total rounds + reps',
          plan: {
            "format": "strength",
            "blocks": [
              {
