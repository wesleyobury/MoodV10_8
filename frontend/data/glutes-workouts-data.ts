    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Cap every set with the finisher: 10s Iso Hold at top — it counts, don\'t skip it. The hold is strict: locked position, squeezing hard, no drifting. 3 sets of 8–10 — rest 90s between sets, take all of it.\n3 rounds\n• 8–10 Hip Thrusts\nFinish with 10s Iso Hold at top\nRest 90s',
          plan: {
            "format": "circuit",
            "blocks": [
              {
    ...
    workouts: {
      ...
      advanced: [
        ...
        },
        {
          ...
          battlePlan: 'Instructions: Cap every set with the finisher: 10s Iso Hold on last rep — it counts, don\'t skip it. The hold is strict: locked position, squeezing hard, no drifting. 4 sets of 8 — rest 90s between sets, take all of it.\n4 rounds\n• 8 Kickbacks each leg\nFinish with 10s Iso Hold on last rep\nRest 90s',
          plan: {
            "format": "circuit",
            "blocks": [
              {
